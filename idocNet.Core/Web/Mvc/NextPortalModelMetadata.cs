...
{
	public class NextPortalModelMetadata : DataAnnotationsModelMetadata
	{
		private string _description;

		public NextPortalModelMetadata(DataAnnotationsModelMetadataProvider provider, Type containerType, Func<object> modelAccessor, Type modelType, string propertyName, DisplayColumnAttribute displayColumnAttribute, IEnumerable<Attribute> attributes)
