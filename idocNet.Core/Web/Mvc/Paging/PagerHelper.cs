...
namespace idocNet.Core.Web.Mvc.Paging
{
	public static class PagerHelper
	{
		...
		public static MvcHtmlString Pager(this HtmlHelper helper, int totalPageCount, int pageIndex,string sitePath, string actionName, string controllerName,
			PagerOptions pagerOptions, string routeName, RouteValueDictionary routeValues, IDictionary<string, object> htmlAttributes)
		{
			var builder = new PagerBuilder
				(
		...
		public static MvcHtmlString Pager<T>(this HtmlHelper helper, PagedList<T> pagedList, string sitePath)
		{
			if (pagedList == null)
				return Pager(helper, null, null);
			return Pager(helper, pagedList.TotalPageCount, pagedList.CurrentPageIndex,sitePath, null, null, null, null, null, null);
		}
		...
		public static MvcHtmlString Pager<T>(this HtmlHelper helper, PagedList<T> pagedList, PagerOptions pagerOptions, string sitePath)
		{
			if (pagedList == null)
				return Pager(helper, pagerOptions, null);
			return Pager(helper, pagedList.TotalPageCount, pagedList.CurrentPageIndex,sitePath, null, null, pagerOptions, null, null, null);
		}
